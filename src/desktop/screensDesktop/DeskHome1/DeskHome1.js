        ...
        <div className={'deskHome'}>
          ...
          <div onClick={() => console.log("clicked")} className='deskSlideHolder col-md-12 mb-100'>
            <div class="col-md-4">
              <div class="w-100pr">
                <a href="/DeskHome2">
                  <div className={'deskProductHolder'} style={{ backgroundImage: `url(${require('../../../desktop/assetsDesktop/imagesDesk/christieKim.png')})` }}>
                    {/* <div className={"deskArrowPointer"}>
                    <MdArrowBack size={40} color={"#fff"} />
                  </div> */}
                    <div className={"deskProductText"}>
            ...
            <div class="col-md-4">
              <div class="w-100pr">
                <a href="/DeskHome2">
                  <div className={'deskProductHolder'} style={{ backgroundImage: `url(${require('../../../desktop/assetsDesktop/imagesDesk/oliaGozha.png')})` }}>
                    <div className={"deskProductText"}>
            ...
            <div class="col-md-4">
              <div class="w-100pr">
                <a href="/DeskHome2">
                  <div className={'deskProductHolder'} style={{ backgroundImage: `url(${require('../../../desktop/assetsDesktop/imagesDesk/annieSpratt2.png')})` }}>
                    <div className={"deskProductText"}>

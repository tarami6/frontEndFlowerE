...
import levHanak01 from "../../mobile/assetsMobile/imagesMobile/productPage/levHanak01.jpg";
import levHanak02 from "../../mobile/assetsMobile/imagesMobile/productPage/lavHanak02.jpg";

import shkiatHazfon01 from "../../mobile/assetsMobile/imagesMobile/productPage/shkiatHazfon01.jpg";
import shkiatHazfon02 from "../../mobile/assetsMobile/imagesMobile/productPage/shkiatHazfon02.jpg";

import shilgia01 from "../../mobile/assetsMobile/imagesMobile/productPage/shilgia01.jpg";
import shilgia02 from "../../mobile/assetsMobile/imagesMobile/productPage/shilgia02.jpg";
...
export const flowersMobile = [
    ...
    },
    {
        ...
        name: 'סחלב לבן',
        price: '150',
        priceSizes: ["150", "240", "300"],
        sells: 9,
        sell: false,
        image: sahlavLavan01,
        productSlider: [sahlavLavan01, sahlavLavan02],
        description: "סחלב לבן שני ענפים",
        story: 'ככלל, סחלבים הם צמחים רעבים לאור. לקבלת התוצאות הטובות ביותר, עליהם לקבל 12 עד 14 שעות אור בכל יום, כל השנה. בסביבה טרופית, משך ועוצמת האור הטבעי אינו משתנה כמו באקלים ממוזג. מסיבה זו יתכן שתצטרכו להזיז את הסחלבים שלכם ולהשלים בעזרת אור מלאכותי כדי לשמור עליהם מאושרים בחודשי החורף. יש להשקות סחלבים פעם בשבוע. '
    },
    {
        category: "pot",
        name: 'סחלב מנומר',
    ...
    },
    {
        ...
        description: "עציץ דיפנבכיה",
        story: 'דיפנבכיה הוא צמח טרופי שגדל היטב בתוך הרבה אור עקיף. הוא יכול לסבול אור נמוך, אך צמיחתו תאט באופן דרמטי. בהתחשב באור רב יותר, הוא יתחיל לגדול שוב.  יש להשקות את הצמח פעם בשבוע, עלים נשירים הם בדרך כלל סימן לכך שצריך להשקות את הצמח.\n'
    },
    {
        category: "pot",
        name: 'סנסיווריה צבעונית',
        price: '120',
        priceSizes: ["120"],
        sells: 7,
        sell: false,
        ...
        description: "סנסיווריה צבעונית",
        story: 'סנסוריה מטהרת את האוויר המזוהם סביבו ויכול לשמש כמטהר אוויר בסביבת הבית או העבודה. סנסוריה מעדיפה את האור או הצל העקיפים. הימנע מהשקיה ישירה על הצמח.יש להשקות את סנסוריה בקיץ, פעם בשבוע ובחורף פעם בשבועיים, . סנסוריה יש יכול הסתגלות והישרדות גבוהה.'
    },
    {
        category: "pot",
        name: 'גוזמניה ',
        ...
        description: "עציץ גוזמניה",
        story: 'גוזמניה מחייבת טמפרטורות המתנודדות בין 18 ל 24 מעלות צלזיוס, הטמפרטורה של בית או משרד אידיאלית לגידול גוזמניה. המיקום הטוב ביותר לגוזמניה הוא כל מקום בו אין שמש ישירה על הצמח, הגוזמניה לא יכולה לסבול את קרני השמש כשהם נוגעים ישירות בעלה, כך שהצמח שמח באור הולם אך לא בשמש ישירה.\n' +
            '\n' +
            'הימנעו לחלוטין ממקומו בסמוך למקורות חום כמו רדיאטורים, מכיוון שרטיבות היא הדבר שצמח טרופי זה זקוק לו ביותר, לפיכך, חלונות הפונים למזרח או מערבה הם בדרך כלל המקום הטוב ביותר לגוזמניה.\n' +
            'יש להקפיד על השקיה קבועה אך מתונה מכיוון שגוזמניה בדרך כלל לא דורשת הרבה מים.'
    },
...
export const chocolateMobile = [
    {
        ...
        sells: 13,
        sell: false,
        image: ferrerorosheGadol,
        productSlider: [ferrerorosheGadol],
...
export const SeoMeta = {
    homePage: {
        ...
        keywords: "חנות פרחים,משלוח פרחים,משלוח פרחים בחיפה, משלוח פרחים בקריות, משלוח פרחים בנשר, משלוח פרחים בטירת הכרמל, זר פרחים, זר ורדים"
    },
    potPage: {
        ...
        keywords: "חנות פרחים,משלוח עציצים,משלוח עציצים בחיפה, משלוח עציצים בקריות, משלוח עציצים בנשר, משלוח עציצים בטירת הכרמל,עציצים, סחלב, סחלבים, גוזמניה, סנסיווריה"

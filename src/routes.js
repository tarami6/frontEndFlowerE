...
const MobileHome01 = asyncComponent(() =>
    import('./mobile/screensMobile/MobileHome01/MobileHome01').then(module => module.default)
)
const ProductPage = asyncComponent(() =>
    import('./mobile/screensMobile/ProductPage/ProductPage').then(module => module.default)
)
const DeskHome1 = asyncComponent(() =>
    import('./desktop/screensDesktop/DeskHome1/DeskHome1').then(module => module.default)
)
const DeskProductPage = asyncComponent(() =>
    import('./desktop/screensDesktop/DeskProductPage/DeskProductPage').then(module => module.default)
)
const Pot = asyncComponent(() =>
    import('./mobile/screensMobile/Pot/Pot').then(module => module.default)
)
